...
<div class="d-none position-rel p_t-b items-center setup992" id="navbar">
    <div class="container grey">
        <div class="space-flex">
            ...
            <!-- part two -->
            <div>
                <p><a id="login" class="hover n-decoration grey" href="./khach_hang/login_register.php">Đăng Nhập</a> / <a id="register" class="hover n-decoration grey" href="#">Đăng Ký</a></p>
