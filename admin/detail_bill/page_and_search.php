...
where bill.id = $id and customer.name like '%$search%'";
...
$query = "
select detail_bill.id as id, customer.name as name_customer, product.name as name_product, product.image as image_product, detail_bill.quantity as quantity
from detail_bill 
join bill on bill.id = detail_bill.id_bill
join customer on customer.id = detail_bill.id_customer
join product on product.id = detail_bill.id_product
where bill.id = $id and customer.name like '%$search%'
group by detail_bill.id, customer.name, product.name, product.image, detail_bill.quantity
