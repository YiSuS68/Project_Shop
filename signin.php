<div class="tab-pane active">
    <form class="login" name="signIn" method="post" onsubmit="return check_validation_signin()" action="process_signin.php" id="form1">
        ...
        <input class="input-login" type="text" name="user_name_signin" id="user_name_signin" placeholder="Tên đăng nhập">
        <i class="fas fa-user"></i>
        <span id="password_signin_empty" class="show-error">Mật khẩu không được để trống!</span>
        <input class="input-login" type="password" name="password_signin" id="user_name_signin" placeholder="Mật khẩu">
